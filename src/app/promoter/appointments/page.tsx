      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-900">Manage site visit requests for your properties. Confirm or reschedule with buyers securely.</p>
          </div>
                          ...
                          {isPending ? (
                            <>
                              ...
                              <button
                                ...
                                disabled={updatingId === appointment.id}
                                className="px-5 py-2.5 border border-gray-300 hover:border-red-300 hover:bg-red-50 text-gray-900 hover:text-red-600 rounded-full font-medium transition-all text-sm disabled:opacity-50"
                              >
                                Reject
                              </button>
                            </>
                          ) : (
                            <span className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-900 rounded-full font-medium text-sm">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl transform transition-all">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 text-gray-900 rounded-full hover:bg-gray-50 font-medium transition-all"
                >
                  Cancel
                </button>
                <button
