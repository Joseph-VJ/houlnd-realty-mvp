...
import { getPromoterDashboardStats, getRecentUnlocks } from '@/app/actions/dashboard'
      ...
      try {
        ...
        if (statsResult.success && statsResult.data) {
          setStats({
            ...
            upcoming_appointments: statsResult.data.active_appointments_count || 0,
          })
        }

        // Fetch recent unlocks
        const unlocksResult = await getRecentUnlocks(5)
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center gap-4">
                <Link href="/promoter/listings" className="text-gray-700 hover:text-gray-900 font-medium transition-colors">
                  My Listings
                </Link>
                <Link href="/promoter/appointments" className="text-gray-700 hover:text-gray-900 font-medium transition-colors">
                  Appointments
                </Link>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-10">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-600 font-medium">Pending Verification</div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-600 font-medium">Live Listings</div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-600 font-medium">Total Unlocks</div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-600 font-medium">Upcoming Visits</div>
                </div>
              </div>
                      ...
                      {recentUnlocks.map((unlock) => (
                        ...
                        >
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-gray-700 font-medium">{unlock.customer_phone}</div>
                            <div className="text-sm text-gray-500 mt-2">{unlock.listing_title}</div>
                          </div>
