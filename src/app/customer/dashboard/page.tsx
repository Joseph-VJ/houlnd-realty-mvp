    ...
    const fetchDashboardData = async () => {
      try {
        ...
        if (result.success && result.data) {
          setStats({
            saved_properties: result.data.saved_properties_count,
            unlocked_properties: result.data.unlocked_contacts_count,
            upcoming_appointments: result.data.active_appointments_count,
          })
        }
      } catch (error) {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href="/customer/saved" className="text-gray-700 hover:text-gray-900 font-medium transition-colors">
                  Saved
                </Link>
                <Link href="/customer/appointments" className="text-gray-700 hover:text-gray-900 font-medium transition-colors">
                  Appointments
                </Link>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-10">
            ...
            <form onSubmit={handleQuickSearch} className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1">
                <label htmlFor="minPpsf" className="block text-sm font-bold text-gray-700 mb-2">
                  Min ₹/sq.ft
                </label>
                <input
                  id="minPpsf"
              ...
              <div className="flex-1">
                <label htmlFor="maxPpsf" className="block text-sm font-bold text-gray-700 mb-2">
                  Max ₹/sq.ft
                </label>
                <input
                  id="maxPpsf"
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-600 font-medium mb-3">Saved Properties</div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-600 font-medium mb-3">Unlocked Properties</div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-600 font-medium mb-3">Upcoming Visits</div>
