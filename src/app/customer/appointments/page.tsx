      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">Manage your upcoming property visits and buyer inquiries securely. Confirm visits or reschedule with a single tap.</p>
          </div>
                        ...
                        <div className="flex flex-wrap gap-2 pt-2">
                          ...
                          {isPending && (
                            <button
                              ...
                              className="px-4 py-2 border border-gray-300 hover:border-red-300 hover:bg-red-50 text-gray-700 hover:text-red-600 rounded-full font-medium transition-all text-sm disabled:opacity-50"
                            >
