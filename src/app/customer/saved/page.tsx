      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center gap-4">
                <Link href="/customer/dashboard" className="text-gray-900 hover:text-gray-900 font-medium transition-colors">
                  Dashboard
                </Link>
                <Link href="/search">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-900">Your favorite properties in one place</p>
          </div>
                ...
                return (
                  <div key={savedProp.id} className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden group">
                    ...
                    <div className="p-5">
                      ...
                      {listing.locality && (
                        <p className="text-sm text-gray-900 mb-3">{listing.locality}</p>
                      )}
                      ...
                      {/* Saved Date */}
                      <div className="text-xs text-gray-900 mb-4 font-medium">
