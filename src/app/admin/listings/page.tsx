      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            ...
            <Link href="/admin/dashboard" className="inline-flex items-center gap-2 px-6 py-2.5 border-2 border-gray-300 text-gray-900 rounded-full font-bold hover:bg-gray-50 transition-all hover:scale-105">
              ← Back to Dashboard
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-white rounded-lg border p-4 mb-6">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-gray-900 placeholder:text-gray-900"
            />
            ...
            {searchQuery && (
              <button
                ...
                className="px-6 py-3 border-2 border-gray-300 text-gray-900 rounded-full font-bold hover:bg-gray-50 transition-all hover:scale-105"
              >
                Clear
              </button>
            )}
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-900 mt-2">Loading listings...</p>
          </div>
        )}
        ...
        {!loading && listings.length === 0 && (
          <div className="bg-white rounded-lg border p-12 text-center">
            <p className="text-gray-900">No listings found</p>
            {searchQuery && (
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-4 gap-4 mb-3">
                        <div>
                          <p className="text-sm text-gray-900 mb-1">Total Price</p>
                        ...
                        <div>
                          <p className="text-sm text-gray-900 mb-1">Bedrooms</p>
                          <p className="text-lg font-semibold text-gray-900">
                            {listing.bedrooms || 'N/A'}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-900 mb-1">Bathrooms</p>
                          <p className="text-lg font-semibold text-gray-900">
                      ...
                      <div className="bg-gray-50 rounded-lg p-3 mb-3">
                        <p className="text-sm text-gray-900 mb-1">Promoter</p>
                    ...
                    <div className="flex-shrink-0 flex flex-col gap-2">
                      <Link href={`/property/${listing.id}`} className="w-full px-6 py-2.5 border-2 border-gray-300 text-gray-900 rounded-full font-bold hover:bg-gray-50 transition-all hover:scale-105 text-center">
                        View Details
                      </Link>
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-6 py-2.5 border-2 border-gray-300 text-gray-900 rounded-full font-bold hover:bg-gray-50 transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                Previous
              </button>
              <button
