        ...
        <section className="bg-white p-8 rounded-lg shadow-sm mb-8">
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span className="text-gray-900">Zero brokerage fees - Pay only ₹99 to unlock verified owner contact</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-600 mr-2">✓</span>
              <span className="text-gray-900">Transparent price per sqft filtering for easy comparison</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-600 mr-2">✓</span>
              <span className="text-gray-900">Every property verified by our team before going live</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-600 mr-2">✓</span>
              <span className="text-gray-900">Direct contact with property owners - no intermediaries</span>
            </li>
          </ul>
        </section>
