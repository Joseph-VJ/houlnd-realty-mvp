  ...
  return (
    <div className="py-16 text-center sm:py-24">
      ...
      <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6">
        <Link href="/register?type=customer" className="group relative w-full sm:w-auto">
          <div className="rounded-xl border-2 border-blue-600 bg-white p-8 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <div className="inline-flex items-center text-blue-600 font-semibold">
              Get Started
              <svg className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform"
        ...
        <Link href="/register?type=promoter" className="group relative w-full sm:w-auto">
          <div className="rounded-xl border-2 border-blue-600 bg-white p-8 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
            <div className="text-4xl mb-3">💼</div>
