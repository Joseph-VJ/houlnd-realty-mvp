    ...
    <form onSubmit={handleSubmit}>
          ...
          <div className="border border-gray-200 rounded-xl p-5">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <div className="font-bold">{formData.property_type}</div>
              </div>
              <div>
                <div className="text-gray-700">Price Type</div>
                <div className="font-bold">{formData.price_type}</div>
              </div>
              <div>
              ...
              <div className="col-span-2">
                <div className="text-gray-700">Price per sq.ft</div>
          ...
          <div className="border border-gray-200 rounded-xl p-5">
            ...
            <div className="space-y-2 text-sm">
              <div>
                ...
                <div className="font-bold">{formData.city}</div>
              </div>
              <div>
                <div className="text-gray-700">Locality</div>
                <div className="font-bold">{formData.locality}</div>
              </div>
              {formData.address && (
                <div>
            ...
            <div className="border border-gray-200 rounded-xl p-5">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div>
                  ...
                  <div className="font-bold">{formData.bedrooms} BHK</div>
                </div>
                <div>
                  <div className="text-gray-700">Bathrooms</div>
                  <div className="font-bold">{formData.bathrooms}</div>
                </div>
                <div>
                  <div className="text-gray-700">Furnishing</div>
                  <div className="font-bold">
            ...
            <div className="border border-gray-200 rounded-xl p-5">
              ...
              <div className="flex flex-wrap gap-2">
                {formData.amenities.map((amenity) => (
                  <div
                    key={amenity}
                    className="px-3 py-1.5 bg-blue-50 border border-blue-300 rounded-full text-sm text-gray-700 font-medium"
                  >
                    {amenity}
                  </div>
                ))}
      ...
      <div className="mt-6 flex justify-between gap-4">
        <button
          ...
          disabled={submitting}
          className="flex items-center gap-2 px-8 py-3 border-2 border-gray-300 text-gray-700 rounded-full font-bold hover:bg-gray-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
