    ...
    <form onSubmit={handleSubmit}>
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
        <div className="space-y-6">
          <div>
            <h2 className="text-3xl font-black text-gray-900 mb-2">Commission Agreement</h2>
          ...
          {/* Agreement Terms */}
          <div className="border border-gray-300 rounded-xl p-6 bg-gray-50 max-h-96 overflow-y-auto">
            ...
            <div className="space-y-4 text-sm text-gray-700">
              <section>
                <h4 className="font-bold text-gray-900 mb-2">1. Commission Structure</h4>
                <p>
              ...
              <section>
                <h4 className="font-bold text-gray-900 mb-2">2. Contact Unlock Fee</h4>
                <p>
              ...
              <section>
                <h4 className="font-bold text-gray-900 mb-2">3. Listing Approval</h4>
                <p>
              ...
              <section>
                <h4 className="font-bold text-gray-900 mb-2">4. Accurate Information</h4>
                <p>
              ...
              <section>
                <h4 className="font-bold text-gray-900 mb-2">5. Property Ownership</h4>
                <p>
              ...
              <section>
                <h4 className="font-bold text-gray-900 mb-2">6. Commission Payment</h4>
                <p>
              ...
              <section>
                <h4 className="font-bold text-gray-900 mb-2">7. Listing Removal</h4>
                <p>
              ...
              <section>
                <h4 className="font-bold text-gray-900 mb-2">8. Privacy & Data</h4>
                <p>
              ...
              <section>
                <h4 className="font-bold text-gray-900 mb-2">9. Dispute Resolution</h4>
                <p>
              ...
              <section>
                <h4 className="font-bold text-gray-900 mb-2">10. Modifications</h4>
                <p>
            ...
            <div className="mt-6 pt-4 border-t border-gray-300">
              <p className="text-sm text-gray-700">
                ...
                <a href="/legal/commission" className="text-blue-600 hover:underline font-medium">
