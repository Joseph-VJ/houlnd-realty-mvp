        ...
        <div className="space-y-6">
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-gray-900 mb-2">Latitude</label>
                <input
                  type="number"
                  step="any"
              ...
              <div>
                <label className="block text-xs font-medium text-gray-900 mb-2">Longitude</label>
                <input
                  type="number"
                  step="any"
          ...
          {formData.city && formData.locality && (
            <div className="p-5 bg-blue-50 border border-blue-200 rounded-xl">
              <div className="text-sm text-gray-900 mb-1 font-medium">Property Location</div>
