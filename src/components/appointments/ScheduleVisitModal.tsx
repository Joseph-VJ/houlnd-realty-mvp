    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-900 mt-1 line-clamp-1">{listingTitle}</p>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          {/* Visitor Name */}
          <div>
            <label htmlFor="visitorName" className="block text-sm font-semibold text-gray-900 mb-2">
          ...
          {/* Visitor Phone */}
          <div>
            <label htmlFor="visitorPhone" className="block text-sm font-semibold text-gray-900 mb-2">
          ...
          <div>
            <label htmlFor="visitorEmail" className="block text-sm font-semibold text-gray-900 mb-2">
              Email (Optional)
            </label>
            <input
              type="email"
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex-1 px-5 py-3 border border-gray-300 text-gray-900 rounded-full hover:bg-gray-50 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
            <button
